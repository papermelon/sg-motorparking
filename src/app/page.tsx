    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <header className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            >
              <h1 className="text-3xl font-bold text-white tracking-tight">SG Motorbike Parking</h1>
              <p className="mt-2 text-slate-400">Find motorcycle parking in Singapore</p>
            </Link>
          ...
          <div className="mt-6">
            ...
            />
            {!isLoaded && (
              <p className="text-center text-sm text-slate-400 mt-2">Loading map...</p>
            )}
          </div>
          ...
          {searchState.center && (
            <div className="mt-4">
              <p className="text-slate-400 text-sm mb-2">Parking hotspots:</p>
      ...
      {!searchState.center && searchState.isLoading && (
        <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          ...
          <p className="text-slate-400">Finding motorcycle parking...</p>
        </main>
      )}
      ...
      {!searchState.center && !searchState.isLoading && (
        <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <div className="mx-auto h-24 w-24 text-slate-400 mb-6 text-6xl">
              🏍️
            </div>
            ...
            <div className="mb-8">
              <p className="text-slate-400 text-sm mb-3">Or pick a parking hotspot:</p>
              <div className="flex flex-wrap gap-2 justify-center">
                {PRESET_AREAS.map((area) => (
                  <button
                    ...
                    onClick={() => handlePresetArea(area.lat, area.lng, area.label)}
                    disabled={searchState.isLoading}
                    className="px-4 py-2 rounded-lg text-sm font-medium bg-slate-700/50 text-slate-200 hover:bg-slate-600 border border-slate-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {area.label}
                  </button>
                ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-slate-300 mb-10">
            ...
            <div className="border-t border-slate-700/50 pt-6">
              <p className="text-slate-400 text-sm mb-4">Know a motorcycle parking spot we're missing?</p>
              <Link
                href="/suggest"
